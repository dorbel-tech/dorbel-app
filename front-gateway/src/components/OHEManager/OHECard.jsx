          ...
          {registrations.map(registration => (
            <tr key={registration.id} className="ohe-card-user-table-row">
              ...
              <td className="ohe-card-user-links-cell">
                <Button href={registration.user.facebook_url} disabled={!registration.user.facebook_url} bsStyle="link" target="_blank">
                  <i className={'fa fa-2x fa-facebook-square ' + (registration.user.facebook_url ? '' : 'ohe-card-facebook')}></i>
                </Button>
              </td>
            </tr>
          ))}
