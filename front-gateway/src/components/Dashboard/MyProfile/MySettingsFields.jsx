      ...
      <div>
        <Row className="my-settings-input">
          <Toggle defaultChecked={settings.allow_publisher_messages}
            ...
            icons={false}></Toggle>
          <label>אפשר למתעניינים לפנות אלי בהודעות דרך מודעת הדירה שלי באתר</label>
        </Row>
        <Row className="my-settings-input">
          <Toggle defaultChecked={settings.receive_like_related_notifications}
            ...
            icons={false}></Toggle>
          <label>שלחו לי עדכונים על מועדי ביקור חדשים של דירות שאהבתי</label>
        </Row>
        <Row className="my-settings-input">
          <Toggle defaultChecked={settings.receive_newsletter}
            ...
            icons={false}></Toggle>
          <label>שלחו לי עדכונים בנוגע לשירותים חדשים</label>
        </Row>
      </div>
    );
  }
