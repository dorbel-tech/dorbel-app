...
class OHEList extends Component {
  ...
  getListingNotification(listing) {
    switch(listing.status) {
      ...
      case 'unlisted':
        return <span>המודעה לא פעילה. <br/>לפרסום המודעה הכנסו <a href={utils.getDashPropertyPath(listing)}>לחשבונכם ועדכנו</a> את הסטטוס שלה.</span>;
      default:
        return null;
    }
  }
  ...
  render() {
    ...
    const closeModal = () => router.setRoute(utils.getListingPath(listing));
