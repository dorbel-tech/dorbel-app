      ...
      <div>
        ...
        <ul>
          {listingStore.apartments.map(apt =>
            <li key={apt.id}><NavLink to={'/apartments/' + apt.apartment.id}>{apt.apartment.building.street_name} {apt.apartment.building.house_number} - {apt.apartment.apt_number}</NavLink></li>
          )}
        </ul>
        {this.props.children}
      </div>
