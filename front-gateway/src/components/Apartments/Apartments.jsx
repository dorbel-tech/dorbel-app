      ...
      <div>
        ...
        <ul>
          {listingStore.apartments.map(apt =>
            <li key={apt.apartment.id}><NavLink to={'/apartments/' + apt.id}>{apt.apartment.building.street_name} {apt.apartment.building.house_number} - {apt.apartment.apt_number}</NavLink></li>
          )}
        </ul>
        {this.props.children}
      </div>
