    ...
    return (
      <div className="container-fluid upload-apt-wrapper">
        ...
        <div className="col-md-5 upload-apt-left-container">
          ...
          <div className="row">
            ...
            <label className="radio-inline">
              <input type="radio" name="inlineRadioOptions" id="inlineRadio1" value="option1" /> בעל הדירה
            </label>
            <label className="radio-inline">
              <input type="radio" name="inlineRadioOptions" id="inlineRadio2" value="option2" /> הדייר הנוכחי
            </label>
          </div>
        </form>
        <div className="form-nav bottom col-lg-5 col-md-5 col-sm-12 col-xs-12">
          ...
          <span>3/3</span>
          <button type="submit" className="btn btn-lg btn-default btn-submit dorbel-btn">שליחה וסיום</button>
        </div>
      </div>
    </div>      
    );
