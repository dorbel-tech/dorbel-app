...
module.exports = {
  ...
  'should fill only apartment details required fields as logged in user': function (browser) {
    login();
  ...
  'should fill only apartment details required fields as anonymous user': function (browser) {
    newApartmentForm
      .navigateToApartmentDetailsSection()
      .fillApartmentDetailsRequiredFields()
      .goFromApartmentDetailsToOpenHouseEvent();
